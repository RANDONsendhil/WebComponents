...
template.innerHTML = `
  ...
  <button tabindex=1 id="increaseBtn">+</button>
  <span tabindex=2 id="label"></span>
  <button tabindex=3 id="decreaseBtn">-</button>
`;
...
export class CounterComponent extends HTMLElement {
	...
	connectedCallback() {
		...
		this.$increaseButton.setAttribute("aria-label", "Zoom plus");
		this.$decreaseButton.setAttribute("aria-label", "Zoom moins");
	}
	...
	attributeChangedCallback(name, oldValue, newValue) {
		...
		this.$label.setAttribute("aria-live", "Zoom à" + newValue);
	}
